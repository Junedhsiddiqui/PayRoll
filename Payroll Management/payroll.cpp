...
void intro()
{
	...
	gotoXY(20,11); printf("Junedh siddiqui");
	gotoXY(20,15); printf("https://www.linkedin.com/in/junedh-siddiqui-9141201b7/");
    gotoXY(24,10);printf("Press Any key to continue...");
    getch();
